...
class MainActivity : AppCompatActivity() {
        ...
        if (savedInstanceState != null) {
            ...
            if (!fragments.isNullOrEmpty()) {
                for (fragment in fragments) {
                    ...
                    fragmentTags.add(fragment.tag.toString())
                }
    ...
    private fun showHome() {
        ...
        showContent(homeFragment!!, HomeFragment.TAG)
    }
    ...
    private fun showGift() {
        ...
        showContent(giftFragment!!, GiftFragment.TAG)
    }
    ...
    private fun showSupport() {
        ...
        showContent(supportFragment!!, SupportFragment.TAG)
    }
    ...
    private fun showCalculation() {
        ...
        if (calDetailFrag != null && calDetailFrag.isAdded) {
            showContent(calDetailFrag, CalculationDetailFragment.TAG)
        } else {
            ...
            showContent(calculationFragment!!, CalculationFragment.TAG)
        }
    }
    ...
    private fun hideCalDetail() {
        ...
        val calDetailFrag = calculationDetailFragment
        if (calDetailFrag != null && calDetailFrag.isAdded) {
            fragmentTags.remove(CalculationDetailFragment.TAG)
        ...
        showContent(calculationFragment!!, CalculationFragment.TAG, transaction)
    }
